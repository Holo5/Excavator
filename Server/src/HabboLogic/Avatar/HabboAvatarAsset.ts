...
export class HabboAvatarAsset {
    find(id: string, type: IType, spritesheet: any): string {
        var _local_6 = type.direction;
        var _local_8 = false;
        var _local_10 = type.gesture;
        var _local_20 = type.partType;
        var _local_21 = type.layerId;
        var _local_23 = type.frame;
        var _local_7: boolean = AvatarDirectionAngle.MISSING_ANGLE[type.direction];
        ...
        _local_24 = `${id}_h_${_local_10}_${_local_20}_${_local_21}_${_local_6}_${_local_23}.png`;
        let asset = spritesheet.frames[_local_24];
        if (asset === undefined) {
            _local_24 = `${id}_h_std_${_local_20}_${_local_21}_${_local_6}_0.png`;
        }
